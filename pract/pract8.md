...
Цель `run`, которая должна запускать файл `main.py` в виртуальном окружении, а в качестве зависимости иметь файл `activate` виртуального окружения

Цель файл `activate` (путь должен включать переменную `VENV`), которая должна создавать виртуальное окружение и устанавливать в него библиотеки из файла `requirements.txt`

Цель `clean`, которая должна удалять файлы в директории `pycache` и виртуальное окружение
